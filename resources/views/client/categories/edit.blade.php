    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 col-sm-12">
                <div class="card">
                    <form action="{{ route('app.categories.update', ['id' => $category->id]) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" required class="form-control"
                                            placeholder="Ex: Materiais" value="{{ $category->name }}">
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <select name="type" required class="form-control">
                                            ...
                                            <option <?= $category->type == 'expense' ? 'selected' : '' ?> value="expense">Despesas</option>
                                            <option <?= $category->type == 'income' ? 'selected' : '' ?> value="income">Receitas</option>
                                        </select>
                                    </div>
                                </div>
                            </div> <!-- ROW -->
